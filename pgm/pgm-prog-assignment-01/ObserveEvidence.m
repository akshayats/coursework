...
for i = 1:size(E, 1),
    ...
    for j = 1:length(F),
        ...
        if (~isempty(indx)),
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            assignments_Fj   = IndexToAssignment(1:length(F(j).val), F(j).card);
            zero_indxs_Fj    = ~(assignments_Fj(:, indx) == x);
            F(j)             = SetValueOfAssignment(F(j), assignments_Fj(zero_indxs_Fj, :), 0);
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
